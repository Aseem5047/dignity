...
export const FOOTER_LINKS = [
	...
	// 	title: "Our Community",
	// 	links: [
	// 		{ label: "Climbing xixixi", route: "/" },
	// 		{ label: "Something Something", route: "/" },
	// 		{ label: "Enriched Care", route: "/" },
	// 	],
	// },
];
...
export const staffPointers = [
	"You must have a Victorian drivers license or be approved to drive in Victoria.",
	"The experience required to apply for a position is 6 months (mandatory).",
	"Cert IV in disability preferred.",
	"Working with Children Check (mandatory if working with a minor under 18 years).",
	"You are required to have a current and valid police clearance check. Clearance check must be clear of any charges and within 3 months of date received. (mandatory).",
	...
	"A skilled communicator with an excellent understanding of written and verbal communication.",
	"Reference checking.",
];
